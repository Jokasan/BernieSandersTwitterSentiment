---
title: "Sentiment Analysis of Bernie Sander Tweets"
date: "`r Sys.Date()`"
...
Text stemming basically reduces to their root form, the SnowballC
...
tweets between the May and July periods. We might want to check out these tweets more closely to see why this was the case, filtering using a regular expression to filter 
